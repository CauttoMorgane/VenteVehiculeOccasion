...
?>
		<section>
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="section-heading">Modifier une annonce</h1>
						<p class="lead section-lead">M2LOccasion site de vente de véhicule d'Occasion.</p>
						<p class="section-paragraph">Ici vous pouvez edditer une annonce afin de vendre vos véhicules d'occasions.</p>
					</div>
				</div>
			</div>	
