						...
						<tbody>
							<?php
								...
								if ($query->rowCount() > 0)
								{
									   ...
									   {
											echo'<tr>
													<td><img class="img-responsive" src="includes/photosAnnonces/'.$data['vehicule_photo'].'"alt="Image non disponible" width="100" height="100"/>
													...
													<td>
														<a class="btn btn-warning" href="adminUpdateAnnonce.php?x='.$data['vehicule_id'].'">Mettre à jour</a>
													</td>
													<td>
														<a class="btn btn-danger" href="adminDeleteAnnonce.php?x='.$data['vehicule_id'].'">Supprimer</a>
													</td>
												</tr>';
										}
								}
