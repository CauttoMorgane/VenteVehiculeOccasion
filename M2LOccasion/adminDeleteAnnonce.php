...
<?php
					...
					while ($data = $query->fetch()){
						...
						<div class="row">
						  <div class="col-sm-offset-4 col-sm-4"">
							<div class="thumbnail">
							<img id="img2" class="img-responsive" class="media-object" src="./includes/photosAnnonces/'.$data['vehicule_photo'].'"alt="Image non disponible"/>
							  <div class="caption">
					...
					$query->closeCursor();
?>					
					<form class="form-horizontal" method="post" action="adminDeleteAnnonce.php">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<a class="btn btn-lg btn-danger" href="adminGererAnnonce.php">Non</a>
							</div>
						</div>
					</form>
				</div>
